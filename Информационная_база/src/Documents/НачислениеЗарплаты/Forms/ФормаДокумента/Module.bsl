...
Процедура НачисленияУдержанияСчетЗатратНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	УправлениеНебольшойФирмойКлиент.НачисленияУдержанияСчетЗатратПараметрыВыбора(ЭтаФорма);
...
Процедура СтраховыеВзносыСчетЗатратНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	УправлениеНебольшойФирмойКлиент.НачисленияУдержанияСчетЗатратПараметрыВыбора(ЭтаФорма, "СтраховыеВзносы");
