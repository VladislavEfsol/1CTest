...
Процедура УстановитьВидимостьИДоступность()
	...
	Элементы.КалькуляцияНаФормеПартия.Видимость = РежимПолнойКалькуляции И КэшЗначений.ИспользоватьПартии;
...
Процедура ЗагрузитьИзФайлаНаСервере(АдресЗагруженныхДанных)
	...
	Для каждого СтрокаТаблицы Из ЗагруженныеДанные Цикл 
		...
		Если ТекущаяСтрокаСостава<0 И СтрокаТаблицы.ЭтоРасход Тогда
		...
		ИначеЕсли НоваяСтрока.Себестоимость=0 И НоваяСтрока.СебестоимостьЕдиницы=0 Тогда
			СтруктураДанные.Вставить("Номенклатура", НоваяСтрока.Номенклатура);
			СтруктураДанные.Вставить("Характеристика", НоваяСтрока.Характеристика);
			СтруктураДанные.Вставить("Спецификация", НоваяСтрока.Спецификация);
			СтруктураДанные.Вставить("ЕдиницаИзмерения", НоваяСтрока.ЕдиницаИзмерения);
		...
		Иначе
			...
			ИначеЕсли НоваяСтрока.СебестоимостьЕдиницы>0 Тогда
				НоваяСтрока.Себестоимость = ?(НоваяСтрока.Количество=0, НоваяСтрока.СебестоимостьЕдиницы, НоваяСтрока.СебестоимостьЕдиницы * НоваяСтрока.Количество);
			КонецЕсли;
