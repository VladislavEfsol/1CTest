...
Процедура НастройкиПрограммы(ТаблицаНастроек, знач РежимРаботы) Экспорт
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		...
		НСтр("ru='Ведение учета табачной продукции,
		|маркируемой кодами маркировки и передача данных о движении табачной продукции в ИС МОТП.'")
	);
	НоваяНастройка.ОбновлятьИнтерфейс = Истина;
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуКоманда(ТаблицаНастроек,
		"НастройкиМОТП",
		"Компания",
		НСтр("ru='Настройки интеграции с ИС МОТП'"),
		НСтр("ru=''")
	);
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.ВместеС = "ВестиУчетТабачнойПродукцииМОТП";
	НоваяНастройка.Зависимости = "ВестиУчетТабачнойПродукцииМОТП";
	НоваяНастройка.Теги = НСтр("ru='Расходная накладная,Номенклатура,Категории номенклатуры'");
...
|Какие еще задачи можно делегировать Даше?");
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		"ИнтеграцияМаркетинг",
		"CRM",
		НСтр("ru='Интеграция с сервисами e-mail маркетинга'"),
		НСтр("ru='Cервисы, позволяющие отслеживать такую информацию по отправленным письмам как: 
		|- открытие письма
		|- переход по ссылке из письма
		|- скачивание вложенных файлов'")
	);
	НоваяНастройка.ПравоРедактирования = Истина;
	НоваяНастройка.Потенциальная = Истина;
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуГиперссылкаНавигации(ТаблицаНастроек,
		...
		"ОбменСКонтрагентами",
		НСтр("ru='Учетные записи ЭДО'"),
		НСтр("ru='Настройка учетных записей для обмена электронными документами.'"),
		"e1cib/list/РегистрСведений.УчетныеЗаписиЭДО"
	);
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуГиперссылкаНавигации(ТаблицаНастроек,
		...
		НСтр("ru=''"),
		"e1cib/list/РегистрСведений.НастройкиОтправкиЭлектронныхДокументов"
	);
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.ВместеС = "ИспользоватьОбменЭД";
	НоваяНастройка.Зависимости = "ИспользоватьОбменЭД";
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуКоманда(ТаблицаНастроек,
		...
		"ОбменСКонтрагентами",
		НСтр("ru='Подключиться к сервису ЭДО'"),
		НСтр("ru='Обмен юридически значимыми электронными документами с контрагентами через сервис ЭДО.'")
	);
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.ВместеС = "ИспользоватьЭлектронныеПодписи";
	НоваяНастройка.Зависимости = "ИспользоватьЭлектронныеПодписи";
	...
	Если РежимРаботы.ЭтоАдминистраторПрограммы
		И ПолучениеОбновленийПрограммы.ДоступноИспользованиеОбновленияПрограммы(Истина)
...
Процедура ПриОпределенииДоступности(знач Идентификатор, ЭлементФормы, Форма) Экспорт
	...
	ИначеЕсли Идентификатор = "НастройкиМОТП" Тогда
		
		ЭлементФормы.Доступность = Форма.ВестиУчетТабачнойПродукцииМОТП
