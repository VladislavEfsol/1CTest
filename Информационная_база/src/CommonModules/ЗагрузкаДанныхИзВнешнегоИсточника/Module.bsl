...
Процедура ПоискВСопоставленныхРаннееЗаголовках(ОбластьПриемник, ПараметрыАвтоПодбораЗаголовка, ИскатьДалее)
	...
	Запрос.УстановитьПараметр("ПолученныйЗаголовок", ПараметрыАвтоПодбораЗаголовка.ПолученныйЗаголовок);
	...
	|	И СоответствиеНаименований.ЗаголовокКолонки ПОДОБНО &ПолученныйЗаголовок";
	...
	Если Выборка.Следующий() Тогда
		...
		ИначеЕсли ЗначениеЗаполнено(Выборка.ДополнительныйРеквизит) Тогда
