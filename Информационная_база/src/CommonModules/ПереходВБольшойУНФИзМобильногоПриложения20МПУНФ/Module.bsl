...
Процедура СтруктурныеЕдиницыМП()
...
Процедура ОтчетОРозничныхПродажахМП()
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		НайтиСоздатьОтчетОРозничныхПродажах(ВыборкаДетальныеЗаписи, ЭтоНоваяЗагрузка, ДокументыДляОтложенногоПроведения);
...
Функция НайтиСоздатьОтчетОРозничныхПродажах(Выборка, ЭтоНоваяЗагрузка, ДокументыДляОтложенногоПроведения)
