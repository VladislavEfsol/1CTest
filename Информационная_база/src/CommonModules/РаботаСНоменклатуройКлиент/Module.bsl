...
//
// Параметры:
//  Форма	 - УправляемаяФорма - форма, из которой происходит выполнение команды.
...
Процедура ВыборВТаблицеФормы(Форма, Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка) Экспорт
	...
	Если Поле.Имя = "НоменклатураСервиса" Тогда
		...
		ИначеЕсли Элемент.ТекущиеДанные.КодСтатусаСопоставленияРаботаСНоменклатурой = 3 Тогда
...
Процедура НайтиКатегорииПоСтрокеПоиска(ОповещениеОЗавершении, ПараметрыПоиска, 
