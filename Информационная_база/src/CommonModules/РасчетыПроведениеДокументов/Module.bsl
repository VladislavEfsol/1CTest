...
Процедура ПодготовитьТаблицуВзаиморасчетовСУчетомАвансов(ДокументСсылка, СтруктураДополнительныеСвойства, ЭтоРасчетыСПоставщиком) Экспорт
	...
	УправлениеНебольшойФирмойСервер.РаспределитьСуммуПоКолонкеТаблицы(ДолгСумма, ВременныеТаблицы.ВременнаяТаблицаПредоплата, "Сумма", "СуммаВал");
	...
	ИначеЕсли ТипЗнч(ДокументСсылка) = Тип("ДокументСсылка.ОтчетКомиссионера") ИЛИ  ТипЗнч(ДокументСсылка) = Тип("ДокументСсылка.ОтчетКомитенту") Тогда
