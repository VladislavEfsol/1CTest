...
Функция НовыйПроизвольныйДокумент(ПараметрыФормирования, ПараметрыФайла) Экспорт
	...
	Если ЗначениеЗаполнено(НастройкиОбменаЭД) Тогда
		...
		Попытка
			...
			ПроизвольныйДокумент.УдалитьПрофильНастроекЭДО     = НастройкиОбменаЭД.ПрофильНастроекЭДО;
			ПроизвольныйДокумент.УдалитьНастройкаЭДО           = НастройкиОбменаЭД.СоглашениеЭД;
