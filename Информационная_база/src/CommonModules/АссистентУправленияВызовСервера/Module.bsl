...
Процедура ВыполнитьЗадачуАссистентаИнтерактивно(ОписаниеСообщения, ДанныеЗадачиСтруктура)
	...
	ФоновоеЗадание = ФоновыеЗадания.Выполнить("ОбсужденияСервер.ЗаписатьОтложенныеСообщенияВСистемуВзаимодействия",,, НСтр("ru = 'Логирование изменений в систему взаимодействия'"));
