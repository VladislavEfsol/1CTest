	...
	Пока ЧтениеXML.Прочитать() Цикл
		...
		Если ЧтениеXML.ТипУзла = ТипУзлаXML.НачалоЭлемента Тогда
			...
			Пока ЧтениеXML.ПрочитатьАтрибут() Цикл
				...
				//ЭтоСсылкаНаКартинку = ПараметрыЧтенияXML.НайденоПоле И ПараметрыЧтенияXML.ЭлементТекущийИмя = "r:embed" И ПараметрыЧтенияXML.ЭлементРодительИмя = "a:blip";    // todo НайденоПоле должно быть истина
