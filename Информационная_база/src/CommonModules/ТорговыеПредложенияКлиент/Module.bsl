...
// Открыть форму формирования заказов через 1С:Бизнес-сеть
//
// Параметры:
//  ПараметрыФормированияЗаказа  - Структура - Параметры открытия формы формирования
//                                             см. ТорговыеПредложенияСлужебный.НовыеПараметрыФормированияЗаказов()
//
Процедура ПерейтиКФормированиюЗаказов(ПараметрыФормированияЗаказа) Экспорт 
	
	ОткрытьФорму("Обработка.ТорговыеПредложения.Форма.ФормированиеЗаказов", ПараметрыФормированияЗаказа);
