...
Процедура ПриОпределенииНастроекРегламентныхЗаданий(Настройки) Экспорт
	...
	НастройкаЗагрузкаКонтактовИзGoogle = Настройки.Добавить();
	НастройкаЗагрузкаКонтактовИзGoogle.РегламентноеЗадание = Метаданные.РегламентныеЗадания.ЗагрузкаКонтактовИзGoogle;
	НастройкаЗагрузкаКонтактовИзGoogle.РаботаетСВнешнимиРесурсами = Истина;
