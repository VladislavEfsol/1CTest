...
Процедура ПриЧтенииНаСервере(ТекущийОбъект)
	...
	ОписаниеДействия = ОписаниеВыбранногоДействия();
	
	Если ОписаниеДействия <> Неопределено Тогда
		ОписаниеПолей = ОписаниеДействия.ОписаниеПолей;
...
Процедура ПриСозданииПриЧтенииНаСервере()
	...
	ТаблицаСобытий = АссистентУправления.НовыйТаблицаСобытий();
	ТаблицаДействий = АссистентУправления.НовыйТаблицаДействий();
	
	АссистентУправления.ПриОпределенииСобытий(ТаблицаСобытий);
	АссистентУправления.ПриОпределенииДействий(ТаблицаДействий);
	
	ЗначениеВРеквизитФормы(ТаблицаДействий, "Действия");
	ЗначениеВРеквизитФормы(ТаблицаСобытий, "События");
...
Функция ОписаниеВыбранногоДействия()
	...
	Возврат АссистентУправления.НайтиОписаниеДействия(Действия, Объект.ТипПредмета, Объект.ДействиеИдентификатор);
...
Процедура ОбновитьЭлементыНастроекЗаполнения()
	...
	ИндексДействия = Действия.Индекс(ОписаниеДействия);
	
	Для Каждого ОписаниеПоля Из ОписаниеДействия.ОписаниеПолей Цикл
		
		Индекс = ОписаниеДействия.ОписаниеПолей.Индекс(ОписаниеПоля);
