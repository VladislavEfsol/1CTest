...
Процедура СформироватьВложенияИВыбратьПолучателейСервер(ВыбранныеКоманды)
	...
	ВыведенныеСообщенияПользователю = Новый Массив;
	...
	Если ЗначениеЗаполнено(ВыбранныеКоманды) Тогда
		...
		Для каждого ВыбраннаяКоманда Из ВыбранныеКоманды Цикл
			...
			ОбщегоНазначенияКлиентСервер.ДополнитьМассив(ВыведенныеСообщенияПользователю, ПолучитьСообщенияПользователю(Истина));
	...
	СообщенияПользователю = Новый ФиксированныйМассив(ВыведенныеСообщенияПользователю);
